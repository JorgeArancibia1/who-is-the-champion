					...
					<div className='p-4 md:p-5'>
						<form action='' className=''>
							...
							<div className='flex justify-between py-1'>
								<button
									type='button'
									className='text-sm hover:underline bg-transparent px-0 border-none focus:outline-none'
									onClick={openJoin}
								>
									Registrate
								</button>
								<button
									type='button'
									className='text-sm hover:underline bg-transparent px-0 focus:outline-none'
								>
